...
int main( int argc, char** argv) 
{
	...
	//time event variables definition
	cudaEvent_t start, stop, kstart, kstop;
	float timeElapsed,ktimeElapsed;
    ...
    int numThreadsPerBlock = atoi(argv[2]);
    //int numBlocks = 8;
	...
	cudaEventElapsedTime(&ktimeElapsed,kstart,kstop);
	...
	printf("Time taken by kernal = %0.2f msecs\n", ktimeElapsed);
	printf("Time taken for execution = %0.2f msecs\n",timeElapsed);
